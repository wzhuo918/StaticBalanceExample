...
public class SpiderAlljobs {
	...
	public static void get_reduce_info(String s) throws IOException {
		Document doc = Jsoup.connect(s).get();
		Elements links = doc.select("a[href]");
		Element reduceEl = links.get(12);// reduce任务链接
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 写文件的目录
		 */
		String s = "/home/wzhuo/example/out1.txt";
		fo = new FileOutputStream(s);

		/**
		 * 遍历所有href的href标签，读取各个job的主页面
		 */
		String jobhistory = "http://172.19.0.164:50030/jobhistoryhome.jsp?pageno=1&search=&scansize=1";
		 ...
		 */
		// String onejoburl =
		// "http://172.19.0.164:50030/jobdetailshistory.jsp?logFile=file:/home/wzhuo/hadoop-1.1.2/logs/history/done/version-1/test164_1394198821447_/2014/03/07/000000/job_201403072126_0001_1394198879741_wzhuo_new%2Bzipf10%2B1";
